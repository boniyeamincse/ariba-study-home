-- Initial data for Linux Study Portal
SET FOREIGN_KEY_CHECKS = 0;
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (1, 'Getting Started', 'getting-started', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (1, 1, 'What is Linux?', 'what-is-linux', '
                <h1>What is Linux?</h1>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (1, 1, 'Explore Linux use cases - Research where Linux is used in the real world', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (2, 1, 'Compare operating systems - List differences between Linux, Windows, and macOS', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (1, 1, 'What makes Linux different from Windows and macOS?', '["It''s more expensive", "It''s open source and free", "It only runs on servers", "It has no graphical interface"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (2, 1, 'Linux History', 'linux-history', '
                <h1>Linux History</h1>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (3, 2, 'Timeline Exercise - Create a timeline of major Linux milestones from 1969 to present', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (4, 2, 'Research Project - Learn about Linus Torvalds and his first Linux announcement', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (2, 2, 'Who created the Linux kernel?', '["Richard Stallman", "Linus Torvalds", "Ken Thompson", "Dennis Ritchie"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (3, 1, 'Choosing a Linux Distribution', 'choosing-a-linux-distribution', '
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (5, 3, 'Distribution Research - Compare 3 different Linux distributions', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (6, 3, 'Try Live USB - Boot a Linux distro from USB without installing', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (3, 3, 'Which distribution is best recommended for beginners?', '["Arch Linux", "Ubuntu", "Gentoo", "Slackware"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (4, 1, 'Debian', 'debian', '
                <h1>Debian</h1>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (7, 4, 'Explore Debian packages - Visit packages.debian.org and search for common software', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (8, 4, 'Learn APT commands - Practice apt-get update, upgrade, and install commands', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (4, 4, 'What package manager does Debian use?', '["YUM", "Pacman", "APT", "Zypper"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (5, 1, 'Red Hat Enterprise Linux', 'red-hat-enterprise-linux', '
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (9, 5, 'Compare RHEL vs CentOS - Research the differences and use cases', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (10, 5, 'Explore Red Hat certifications - Learn about RHCSA and RHCE', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (5, 5, 'What is the package manager used in RHEL?', '["APT", "YUM/DNF", "Pacman", "Portage"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (6, 1, 'Ubuntu', 'ubuntu', '
                <h1>Ubuntu</h1>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (11, 6, 'Try Ubuntu Live - Boot Ubuntu from USB and explore without installing', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (12, 6, 'Explore Ubuntu Software - Browse the Software Center and discover applications', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (6, 6, 'How often does Ubuntu release LTS (Long-Term Support) versions?', '["Every 6 months", "Every year", "Every 2 years", "Every 5 years"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (7, 1, 'Fedora', 'fedora', '
                <h1>Fedora</h1>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (13, 7, 'Explore Fedora Spins - Visit getfedora.org and compare different desktop environments', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (14, 7, 'Learn DNF commands - Practice dnf install, update, and search', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (7, 7, 'What company sponsors Fedora development?', '["Canonical", "Red Hat", "SUSE", "Debian Foundation"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (8, 1, 'Linux Mint', 'linux-mint', '
                <h1>Linux Mint</h1>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (15, 8, 'Compare Desktop Environments - Try Cinnamon, MATE, and Xfce in live mode', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (16, 8, 'Explore Mint Tools - Learn about Update Manager and Software Manager', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (8, 8, 'Which desktop environment is most popular in Linux Mint?', '["GNOME", "KDE", "Cinnamon", "Unity"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (9, 1, 'Gentoo', 'gentoo', '
                <h1>Gentoo</h1>
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (17, 9, 'Read Gentoo Handbook - Study the comprehensive installation guide', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (18, 9, 'Learn about USE flags - Understand how to customize package features', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (9, 9, 'What makes Gentoo unique compared to other distributions?', '["It''s the oldest distro", "It compiles from source", "It has no package manager", "It only runs on servers"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (10, 1, 'Arch Linux', 'arch-linux', '
                <h1>Arch Linux</h1>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (19, 10, 'Explore Arch Wiki - Browse wiki.archlinux.org for comprehensive guides', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (20, 10, 'Learn Pacman - Study pacman commands: -S, -R, -Syu, -Ss', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (10, 10, 'What is the Arch User Repository (AUR)?', '["Official package repository", "Community-maintained packages", "Arch documentation", "Package manager"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (11, 1, 'openSUSE', 'opensuse', '
                <h1>openSUSE</h1>
            ...
            ', 10);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (21, 11, 'Explore YaST - Learn about YaST modules for network, users, and software', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (22, 11, 'Compare Leap and Tumbleweed - Understand the differences and use cases', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (11, 11, 'What is YaST in openSUSE?', '["Package manager", "Desktop environment", "System administration tool", "File system"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (12, 1, 'Installing Linux', 'installing-linux', '
            ...
            ', 11);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (23, 12, 'Create a bootable USB - Use Rufus or Etcher to create installation media', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (24, 12, 'Practice in VM - Install Linux in VirtualBox or VMware first', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (12, 12, 'What is the recommended first step before installing Linux?', '["Delete all files", "Backup important data", "Buy new hardware", "Uninstall antivirus"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (13, 1, 'Virtual Machines & Containers', 'virtual-machines-containers', '
            ...
            ', 12);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (25, 13, 'Install VirtualBox - Set up VirtualBox and create your first Linux VM', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (26, 13, 'Try Docker - Install Docker and run a simple Linux container', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (27, 13, 'Compare Performance - Test startup time and resource usage of VM vs container', 2);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (13, 13, 'What is the main difference between containers and virtual machines?', '["Containers are slower", "Containers share the host kernel", "VMs are more portable", "Containers need more resources"]', 1);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (2, 'Command Line', 'command-line', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (14, 2, 'The Shell', 'the-shell', '
                <h1>The Shell</h1>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (28, 14, 'Check your shell - Run: echo $SHELL to see which shell you''re using', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (29, 14, 'Explore the prompt - Type commands and observe how the prompt behaves', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (14, 14, 'What is the most commonly used shell in Linux?', '["Fish", "Zsh", "Bash", "Ksh"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (15, 2, 'pwd, cd, ls', 'pwd-cd-ls', '
...
$ ls -t              # Sort by modification time</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (30, 15, 'Navigate your system - Use cd to explore /etc, /var, and /usr directories', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (31, 15, 'Practice ls options - Try different combinations like ls -lah, ls -ltr', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (15, 15, 'Which command shows your current directory?', '["cd", "ls", "pwd", "dir"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (16, 2, 'touch, file, cat, less, history', 'touch-file-cat-less-history', '
...
$ Ctrl+R                 # Search history interactively</pre>
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (32, 16, 'Create test files - Use touch to create several files, then view them with cat and less', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (33, 16, 'Explore history - Run various commands, then use history and try rerunning commands with !', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (16, 16, 'Which command is best for viewing large log files?', '["cat", "touch", "less", "file"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (17, 2, 'cp, mv, mkdir, rm', 'cp-mv-mkdir-rm', '
...
$ rm -v file.txt                    # Verbose output</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (34, 17, 'Practice copying - Create test files and copy them with different options', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (35, 17, 'Safe deletion - Create test directories and practice rm with -i flag first', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (17, 17, 'Which flag is needed to copy a directory recursively?', '["-i", "-r", "-v", "-p"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (18, 2, 'find', 'find', '
...
$ find . ! -name "*.txt"            # NOT condition</pre>
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (36, 18, 'Find large files - Use find to locate files larger than 100MB on your system', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (37, 18, 'Clean old files - Find files modified more than 30 days ago in /tmp', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (18, 18, 'Which find option searches for files by name (case-insensitive)?', '["-name", "-iname", "-type", "-size"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (19, 2, 'help, man, whatis, alias, exit', 'help-man-whatis-alias-exit', '
...
$ exit 1                            # Exit with error status</pre>
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (38, 19, 'Explore man pages - Read man pages for 5 different commands', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (39, 19, 'Create useful aliases - Set up aliases for your most-used commands', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (19, 19, 'Which command provides a one-line description of a command?', '["help", "man", "whatis", "info"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (20, 2, 'Command-Line Shortcuts & Tips', 'command-line-shortcuts-tips', '
...
$ command &> all.log                # Redirect both output and errors</pre>
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (40, 20, 'Practice shortcuts - Spend 10 minutes using only keyboard shortcuts', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (41, 20, 'Master Ctrl+R - Use reverse search to find and rerun old commands', 1);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (20, 20, 'Which shortcut clears the terminal screen?', '["Ctrl + C", "Ctrl + L", "Ctrl + D", "Ctrl + Z"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (21, 2, 'Environment Variables', 'environment-variables', '
...
$ export HISTFILESIZE=20000</pre>
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (42, 21, 'Explore your environment - Use env to see all variables, then research 5 unfamiliar ones', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (43, 21, 'Customize PATH - Add a custom directory to your PATH and test it', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (44, 21, 'Create persistent variables - Add custom variables to ~/.bashrc', 2);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (21, 21, 'Which variable contains directories where the shell looks for commands?', '["$HOME", "$PATH", "$SHELL", "$USER"]', 1);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (3, 'Basic Text-Fu', 'basic-text-fu', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (22, 3, 'stdout (Standard Out)', 'stdout-standard-out', '
...
$ ls -l > files_list.txt                 # Saves the directory listing to a file</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (45, 22, 'Run <code>echo ''My first redirect'' > test.txt</code>, then use <code>cat test.txt</code> to view it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (22, 22, 'Which operator is used to append standard output to the end of an existing file without overwriting it?', '[">", ">>", "<", "|"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (23, 3, 'stdin (Standard In)', 'stdin-standard-in', '
...
$ wc -l < script.sh                  # Counts the lines in the script</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (46, 23, 'Use the cat command to read a file by redirecting stdin: <code>cat < /etc/hostname</code>', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (23, 23, 'Which file descriptor number represents Standard Input (stdin)?', '["0", "1", "2", "3"]', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (24, 3, 'stderr (Standard Error)', 'stderr-standard-error', '
...
$ command &> all_output.log        # The modern, shorter way</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (47, 24, 'Try running <code>ls /root 2> oops.txt</code> (as a normal user), then use <code>cat oops.txt</code> to see the captured ''Permission denied'' error.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (24, 24, 'Which command safely discards all error messages (stderr) without cluttering the screen?', '["command > /dev/null", "command 2> /dev/null", "command < /dev/null", "command | /dev/null"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (25, 3, 'pipe and tee', 'pipe-and-tee', '
...
$ ls -l | tee contents.txt | grep "drwx"      # Save full list, but only screen-print directories</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (48, 25, 'Run <code>ls -l /etc | tee my_etc.txt | head -n 5</code>. You will see the first 5 lines on screen, but if you check the file, it contains everything!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (25, 25, 'What is the primary function of the pipe `|` character?', '["It saves output to a file.", "It connects the stdout of one command to the stdin of another.", "It runs two commands simultaneously in the background.", "It redirects stderr to stdout."]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (26, 3, 'env (Environment)', 'env-environment', '
...
$ env -i bash             # Start a completely empty, wiped-clean bash shell for testing</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (49, 26, 'Run <code>env | less</code> to browse through all the hidden variables your Linux system uses to track your session.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (26, 26, 'What does the `env -i` flag do when executing a command?', '["Installs the environment.", "Ignores the current environment, starting with an empty one.", "Interactive mode.", "Inverts the variables."]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (27, 3, 'cut', 'cut', '
...
$ echo "apple,banana,cherry" | cut -d, -f2  # Returns ''banana''</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (50, 27, 'Use <code>cut -d: -f1 /etc/passwd</code> to generate a list of every user account on your machine.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (27, 27, 'If you have a comma-separated file, which flags tell `cut` to use commas and extract the 3rd column?', '["-c 3 -d ,", "-d , -f 3", "-s , -c 3", "-w , -f 3"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (28, 3, 'paste', 'paste', '
...
Bob=30</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (51, 28, 'Create two small files using `echo` and `>`. Then use `paste` to merge them side-by-side on your screen.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (28, 28, 'What character does `paste` use by default to separate the merged lines?', '["Space", "Comma", "Tab", "Newline"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (29, 3, 'head', 'head', '
...
$ head -n 5 /etc/passwd             # View exactly the first 5 lines</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (52, 29, 'Run <code>head -n 3 /etc/os-release</code> to quickly check what flavor of Linux you are currently running.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (29, 29, 'By default, how many lines does the `head` command output if no `-n` flag is provided?', '["5", "10", "20", "50"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (30, 3, 'tail', 'tail', '
...
# Press Ctrl+C to exit follow mode!</pre>
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (53, 30, 'Open a terminal and run <code>tail -f /var/log/syslog</code>. Open a second terminal and do something (like restart a service or plug in a USB) to watch the live output.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (30, 30, 'Which flag allows `tail` to continuously monitor a file and print new text as it is added?', '["-c", "-n", "-f", "-live"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (31, 3, 'expand and unexpand', 'expand-and-unexpand', '
...
$ expand -t 4 code.py               # Replaces each tab with exactly 4 spaces</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (54, 31, 'Create a file with deep tab indentation, then run <code>expand -t 2 file.txt</code> to compress the visual width.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (31, 31, 'If you want `expand` to replace every tab character with exactly 4 spaces, which option do you use?', '["-s 4", "-t 4", "-n 4", "--spaces=4"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (32, 3, 'join and split', 'join-and-split', '
...
$ cat vpart_* > bigvideo.mp4        # How to easily glue them back together!</pre>
            ...
            ', 10);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (55, 32, 'Run <code>split -b 1M /var/log/syslog test_</code> and then <code>ls -l</code> to see the chopped up 1 Megabyte files.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (32, 32, 'What is a strict requirement for the two files before you can successfully use the `join` command on them?', '["They must have the same file extension.", "They must be exactly the same size.", "They must be sorted based on the join field.", "They must contain only numbers."]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (33, 3, 'sort', 'sort', '
                <h1>Ordering Text</h1>
...
$ sort -h sizes.txt                 # Human-readable numeric sort (handles 1K, 5M, 2G sizes!)</pre>
            ...
            ', 11);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (56, 33, 'Run <code>ls -lh /etc | sort -k 5 -h</code> to sort the files in /etc by their human-readable size.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (33, 33, 'Which flag allows `sort` to correctly order sizes like 500M and 2G?', '["-s", "-n", "-h", "-c"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (34, 3, 'tr (Translate)', 'tr-translate', '
            ...
            ', 12);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (57, 34, 'Use <code>cat /etc/hostname | tr ''a-z'' ''A-Z''</code> to print your computer''s name in all uppercase.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (34, 34, 'Why does the command `tr ''a-z'' ''A-Z'' file.txt` fail to work?', '["tr only works on numbers.", "tr does not accept file names as arguments; it strictly requires data from stdin.", "The syntax for uppercase is wrong.", "You need root privileges."]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (35, 3, 'uniq (Unique)', 'uniq-unique', '
...
$ sort access.log | uniq -c | sort -nr # Count occurrences, then sort highest-to-lowest (Top 10 list!)</pre>
            ...
            ', 13);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (58, 35, 'Create a file with some repeated words on different lines. Run `uniq` on it without sorting first to see it fail, then run `sort file.txt | uniq` to see it succeed.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (35, 35, 'To generate a ''Top 10'' frequency list of items in a file, which sequence of commands is required?', '["uniq file.txt | sort -c", "sort file.txt | uniq -c | sort -n", "count file.txt | sort | head 10", "grep -c file.txt"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (36, 3, 'wc and nl', 'wc-and-nl', '
...
$ cat -n code.py                    # (Alternative using cat. Very similar result!)</pre>
            ...
            ', 14);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (59, 36, 'Run <code>ls -1 /usr/bin | wc -l</code> to find out exactly how many command-line binaries your system has installed!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (36, 36, 'If you want to quickly count how many files exist in the current directory, which pipeline works perfectly?', '["ls -l | num", "ls -1 | wc -l", "count *", "find . | nl"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (37, 3, 'grep', 'grep', '
...
$ grep -C 2 "error" server.log      # Context: Print the match AND 2 lines above/below it</pre>
            ...
            ', 15);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (60, 37, 'Run <code>grep -r ''nameserver'' /etc/</code> to find exactly which file configures your DNS servers.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (37, 37, 'Which grep flag is used to ''Invert'' the match, returning only lines that do NOT contain the pattern?', '["-i", "-r", "-v", "-n"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (4, 'Advanced Text-Fu', 'advanced-text-fu', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (38, 4, 'regex (Regular Expressions)', 'regex-regular-expressions', '
...
$ grep "bash$" /etc/passwd       # Find lines ending with ''bash''</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (61, 38, 'Research and try matching a valid IP address using grep and regex on a log file.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (38, 38, 'Which regex character ties the match to the end of a line?', '["*", "^", "$", "."]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (39, 4, 'Text Editors', 'text-editors', '
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (62, 39, 'Run <code>nano test.txt</code>, type some text, and follow the bottom menu (Ctrl+O to save, Ctrl+X to exit).', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (39, 39, 'Which of the following describes Vim?', '["A simple, non-modal editor", "A graphical-only editor", "A fast, ubiquitous, modal terminal editor", "A spreadsheet application"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (40, 4, 'Vim (Vi Improved)', 'vim-vi-improved', '
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (63, 40, 'Open Vim by typing <code>vim</code>. Press <code>i</code> to enter Insert Mode. Press <code>Esc</code> to return to Normal Mode.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (40, 40, 'What is the default mode Vim starts in, where keys act as commands rather than typing text?', '["Insert Mode", "Command Mode", "Visual Mode", "Normal Mode"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (41, 4, 'Vim Search Patterns', 'vim-search-patterns', '
...
n             # Press ''n'' to go to the second ''error'' occurrence</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (64, 41, 'Open a large text file in Vim, type <code>/the</code>, press Enter, and cycle through matches using <code>n</code> and <code>N</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (41, 41, 'While in Normal mode, which key initiates a forward search?', '["Ctrl+F", "/", "?", "s"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (42, 4, 'Vim Navigation', 'vim-navigation', '
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (65, 42, 'Open Vim and force yourself to navigate a document using only h, j, k, l, w, and b. Do not touch the arrow keys!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (42, 42, 'Which key combination jumps instantly to the very bottom of the file?', '["gg", "$", "G", "End"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (43, 4, 'Vim Inserting and Appending Text', 'vim-inserting-and-appending-text', '
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (66, 43, 'In Normal mode, move the cursor to the middle of a line. Press <code>A</code> to instantly jump to the end of the line and begin typing.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (43, 43, 'Which key instantly creates a new empty line BELOW your cursor and enters Insert mode?', '["i", "a", "o", "O"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (44, 4, 'Vim Editing', 'vim-editing', '
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (67, 44, 'Delete 3 lines at once by typing <code>3dd</code> in Normal mode, then press <code>u</code> to undo it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (44, 44, 'What is the Normal mode command to copy (yank) 4 complete lines of text at once?', '["copy 4", "4yy", "y4y", "Ctrl+C 4"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (45, 4, 'Vim Saving and Exiting', 'vim-saving-and-exiting', '
...
Enter       # 3. Press Enter to execute</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (68, 45, 'Open a file, type some garbage text, and then exit by forcing it to quit without saving using <code>:q!</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (45, 45, 'You made a horrible mistake editing a file and want to exit Vim immediately without saving any of your messy changes. What do you type?', '[":w", ":wq", ":exit", ":q!"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (46, 4, 'Emacs', 'emacs', '
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (69, 46, 'Open your terminal and type <code>emacs -nw</code> to start Emacs in the console without opening a new GUI window.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (46, 46, 'In Emacs documentation, what keyboard key does the prefix `M-` typically represent on a modern PC?', '["Shift", "Ctrl", "Alt", "Windows Key"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (47, 4, 'Emacs Manipulate Files', 'emacs-manipulate-files', '
...
5. Press Ctrl+x, then Ctrl+s to save.</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (70, 47, 'Open Emacs, use <code>C-x C-f</code> to create a file called <code>hello.txt</code>, type your name, and save it using <code>C-x C-s</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (47, 47, 'Which chording sequence is used to ''Find'' (open) a file in Emacs?', '["C-o", "C-x C-f", "M-f", "C-f"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (48, 4, 'Emacs Buffer Navigation', 'emacs-buffer-navigation', '
            ...
            ', 10);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (71, 48, 'Type a long sentence in Emacs and practice jumping word-by-word using <code>Alt+f</code> and <code>Alt+b</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (48, 48, 'Which Emacs shortcut jumps the cursor to the very end of the current line?', '["C-n", "M-f", "C-e", "C-a"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (49, 4, 'Emacs Editing', 'emacs-editing', '
            ...
            ', 11);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (72, 49, 'Move your cursor to the middle of a line, press <code>C-k</code> to kill the rest of the line, move down, and press <code>C-y</code> to yank it back.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (49, 49, 'In Emacs terminology, what does ''Yanking'' do?', '["Deletes a line", "Copies a selection", "Pastes text from the kill ring", "Undoes the last action"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (50, 4, 'Emacs Exiting and Help', 'emacs-exiting-and-help', '
...
# (If you have unsaved files, it will ask you if you want to save them first).</pre>
            ...
            ', 12);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (73, 50, 'Open Emacs and immediately press <code>C-h t</code> to load the famous built-in Emacs tutorial buffer!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (50, 50, 'What is the crucial ''Cancel / Abort'' sequence you should press if you get stuck in half of an Emacs command?', '["Esc Esc Esc", "C-c", "C-g", "C-d"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (5, 'User Management', 'user-management', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (51, 5, 'Users & Groups Architecture', 'users-groups-architecture', '
...
$ cat /etc/group    # Lists groups and their members</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (74, 51, 'View the last 5 lines of <code>/etc/passwd</code> using <code>tail -n 5 /etc/passwd</code> to see recently created users.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (51, 51, 'Which critical system file stores the encrypted passwords for user accounts?', '["/etc/passwd", "/etc/group", "/etc/shadow", "/etc/sudoers"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (52, 5, 'Managing User Accounts', 'managing-user-accounts', '
...
$ sudo usermod -aG developers bob     # Append (-a) bob to the supplementary group (-G) ''developers''</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (75, 52, 'Check which groups your current user belongs to by typing <code>groups</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (52, 52, 'In the command `usermod -aG developers bob`, what does the `-a` flag do?', '["It assigns ''developers'' as the primary group.", "It creates the group ''developers''.", "It Appends the user to the group without removing them from their existing groups.", "It Activates the user account."]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (53, 5, 'The Power of Root & Sudo', 'the-power-of-root-sudo', '
...
$ su - bob            # Switch user to ''bob'' (requires bob''s password)</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (76, 53, 'Run <code>sudo -i</code> to become root, look at your prompt, and then type <code>exit</code> to return to your normal user.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (53, 53, 'Which of the following is NOT a benefit of using ''sudo'' instead of logging in directly as root?', '["Sudo tracks commands in an audit log.", "Sudo requires the administrator to share the universal root password.", "Sudo privileges can be restricted to specific commands.", "Sudo sessions time out automatically for safety."]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (54, 5, 'File Permissions (chmod & chown)', 'file-permissions-chmod-chown', '
...
$ chmod 644 document.txt       # Standard file: User gets 6 (rw-), Group/Others get 4 (r--)</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (77, 54, 'Create an empty file <code>touch mydata.txt</code>. Then strip all permissions from it <code>chmod 000 mydata.txt</code>. Try to <code>cat</code> it. Finally, restore it with <code>chmod 644 mydata.txt</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (54, 54, 'In octal mode, what number represents read AND write permissions, but NOT execute? (4=Read, 2=Write, 1=Execute)', '["7", "5", "6", "3"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (6, 'Processes & Jobs', 'processes-jobs', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (55, 6, 'Introduction to Processes', 'introduction-to-processes', '
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (78, 55, 'Research what happens to a ''Child'' process if its ''Parent'' process is suddenly killed before the Child finishes executing. (Hint: Look up ''Orphan processes'').', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (55, 55, 'What is the Process ID (PID) of the very first process started by the Linux Kernel during boot?', '["PID 0", "PID 1", "PID 100", "PID 9999"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (56, 6, 'Static Monitoring (ps)', 'static-monitoring-ps', '
...
$ ps aux | grep "nginx"          # Quickly find the PID of the Nginx web server</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (79, 56, 'Run <code>ps aux</code> on your terminal. Try to find the process corresponding to the Bash shell you are currently typing in.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (56, 56, 'Which of these ps commands is the most common industry standard for viewing absolutely every running process on the system?', '["ps -all", "ps -u", "ps aux", "ps show"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (57, 6, 'Dynamic Monitoring (top & htop)', 'dynamic-monitoring-top-htop', '
...
$ htop             # Launch the modern interactive monitor (often needs to be installed via apt/yum)</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (80, 57, 'Launch <code>top</code>. Observe the ''load average'' numbers in the top right corner. Press <code>q</code> to exit when done.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (57, 57, 'What keyboard key do you press to cleanly exit the ''top'' interactive monitor interface?', '["Esc", "Ctrl+C", "q", "x"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (58, 6, 'Process States & Controlling Terminals', 'process-states-controlling-terminals', '
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (81, 58, 'Run <code>ps aux</code> and scan the STAT column. Notice how almost every process is in the ''S'' (Sleep) state, waiting to be needed.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (58, 58, 'What does a ''Z'' in the STAT column of the ps command indicate?', '["Zooming (High Priority)", "Zero (No RAM usage)", "Zombie (Dead process waiting for parent)", "Zipped (Compressed process)"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (59, 6, 'The /proc Virtual Filesystem', 'the-proc-virtual-filesystem', '
...
$ cat /proc/1/status    # View human-readable status information about PID 1</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (82, 59, 'Run <code>cat /proc/uptime</code> to ask the kernel exactly how many seconds the system has been running since boot.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (59, 59, 'Where does the /proc directory physically reside?', '["On the primary hard drive partition", "In the /etc directory", "It is an illusion; it exists entirely within system RAM/Kernel", "On the boot USB"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (60, 6, 'Process Priority (nice and renice)', 'process-priority-nice-and-renice', '
...
$ renice -n -5 -p 1234                           # Change an ALREADY RUNNING process (PID 1234) to a negative (high) priority. Requires sudo.</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (83, 60, 'Start a heavy command with a very low priority by passing it through <code>nice -n 19</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (60, 60, 'Which ''nice'' value represents the absolute highest priority on the system (the most ''selfish'' process)?', '["100", "0", "19", "-20"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (61, 6, 'Sending Signals', 'sending-signals', '
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (84, 61, 'Run a command like <code>ping 8.8.8.8</code>. Notice it runs forever. Press <code>Ctrl+C</code> to send a SIGINT signal and politely interrupt it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (61, 61, 'When you press Ctrl+C to stop a running command in the terminal, which numbered signal is silently sent beneath the hood?', '["2 (SIGINT)", "9 (SIGKILL)", "15 (SIGTERM)", "1 (SIGHUP)"]', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (62, 6, 'Terminating Processes', 'terminating-processes', '
...
$ killall -9 nginx       # Force kills any process exactly named ''nginx''</pre>
            ...
            ', 7);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (62, 62, 'You want to gracefully shut down a runaway Ruby script, but you only know its exact numerical PID is 8192. Which command is safest?', '["kill -9 8192", "pkill 8192", "kill 8192", "killall 8192"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (63, 6, 'Background Jobs', 'background-jobs', '
...
[1] 14522                # Bash tells you this is Job 1, mapped to PID 14522.</pre>
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (85, 63, 'Launch the sleep command into the background by typing <code>sleep 300 &</code>. Validate it is running silently by typing <code>jobs</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (63, 63, 'What symbol must be appended to the absolute end of a bash command to launch it quietly in the background?', '["*", "$", "&", "%"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (64, 6, 'Foregrounding and Suspending', 'foregrounding-and-suspending', '
...
$ fg %1                  # Bring Job [1] back to the foreground to watch it finish.</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (86, 64, 'Run <code>sleep 500</code>. Pause it using Ctrl+Z. Run <code>jobs</code> to see it ''Stopped''. Formally resume it using the <code>bg</code> command.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (64, 64, 'If a command is currently blocking your terminal, what keyboard shortcut will instantly pause it and return your interactive prompt?', '["Ctrl+C", "Ctrl+D", "Ctrl+B", "Ctrl+Z"]', 3);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (7, 'Software Management', 'software-management', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (65, 7, 'Software Distribution & Repositories', 'software-distribution-repositories', '
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (87, 65, 'Research what a ''PPA'' (Personal Package Archive) is in the Ubuntu ecosystem and why you should be careful adding them.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (65, 65, 'What is the primary security benefit of downloading software via an official Linux repository rather than a random website?', '["It downloads faster", "The software is cryptographically signed and tested for compatibility", "It saves hard drive space", "It avoids needing an internet connection"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (66, 7, 'dpkg (Debian Package Manager)', 'dpkg-debian-package-manager', '
...
$ dpkg -L nginx              # List all files installed by a specific package</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (88, 66, 'Run <code>dpkg -l | less</code> to scroll through the massive list of every single package currently installed on your Debian/Ubuntu machine.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (66, 66, 'What is the primary drawback of using the low-level `dpkg -i` command to install software?', '["It is too slow", "It only works on Red Hat", "It does not automatically resolve and download dependencies", "It requires a GUI"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (67, 7, 'apt (Advanced Package Tool)', 'apt-advanced-package-tool', '
...
$ sudo apt autoremove             # Clean up ''orphaned'' dependencies you no longer need</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (89, 67, 'Run <code>apt search vim</code>. How many packages on the repository mention the word ''vim''?', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (67, 67, 'Which APT command entirely removes a software package ALONG with all of its customized configuration files?', '["apt remove", "apt delete", "apt purge", "apt clear"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (68, 7, 'rpm (Red Hat Package Manager)', 'rpm-red-hat-package-manager', '
...
$ sudo rpm -e package_name        # Erase (uninstall) a package</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (90, 68, 'If you have access to a Red Hat-based system, run <code>rpm -qa | grep ssh</code> to see SSH-related packages installed.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (68, 68, 'Which low-level package file format is native to the Red Hat Enterprise Linux family?', '[".exe", ".deb", ".rpm", ".tar"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (69, 7, 'yum and dnf (Fedora/RHEL)', 'yum-and-dnf-fedora-rhel', '
...
$ sudo dnf history undo 14        # Instantly rollback Transaction #14!</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (91, 69, 'Compare the command to install Apache on Ubuntu (<code>apt install apache2</code>) vs Red Hat (<code>dnf install httpd</code>).', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (69, 69, 'Which unique feature of DNF allows administrators to easily ''undo'' an entire software installation transaction?', '["dnf rollback", "dnf history undo", "dnf reverse", "apt revert"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (70, 7, 'pacman (Arch Linux)', 'pacman-arch-linux', '
...
$ sudo pacman -Rs neofetch        # Remove the package and its unused dependencies (s)</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (92, 70, 'Research the Arch User Repository (AUR) and learn why it makes Arch Linux uniquely powerful for developers.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (70, 70, 'In Arch Linux, which command is famously used to update all repositories and upgrade the entire system simultaneously?', '["pacman -update", "pacman -Syu", "apt upgrade", "dnf update"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (71, 7, 'Universal Packages (Snap & Flatpak)', 'universal-packages-snap-flatpak', '
...
$ flatpak install flathub gimp    # Universal install of the GIMP image editor</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (93, 71, 'Run <code>snap list</code> or <code>flatpak list</code> on your desktop to see what containerized apps you are running.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (71, 71, 'What is the primary drawback of using universal packaging formats like Snap or Flatpak?', '["They are insecure", "They only work on Ubuntu", "They consume significantly more disk space and memory", "They require compiling from source"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (72, 7, 'tar (Tape Archive)', 'tar-tape-archive', '
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (94, 72, 'Create a directory with a few text files, and bundle them into a single <code>archive.tar</code> using <code>tar -cvf</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (72, 72, 'What does the ''f'' flag in the tar command specify?', '["Force the creation", "Fast mode", "File name follows immediately", "Format to ZIP"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (73, 7, 'Compression (gzip and bzip2)', 'compression-gzip-and-bzip2', '
...
$ tar -xzvf web_backup.tar.gz                   # eXtract, Zip(decompress), Verbose, File</pre>
            ...
            ', 8);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (73, 73, 'Which flag is added to the tar command to tell it to compress the archive using gzip, resulting in a .tar.gz file?', '["-z", "-g", "-c", "-p"]', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (74, 7, 'Compiling from Source', 'compiling-from-source', '
...
$ sudo make install</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (95, 74, 'Research why the <code>build-essential</code> package on Ubuntu is absolutely necessary before you attempt to compile anything.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (74, 74, 'In the standard Linux compilation workflow, what does the ''./configure'' script do?', '["Translates code to binary", "Installs the executable", "Deletes old files", "Inspects the system to ensure dependencies exist before compiling"]', 3);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (8, 'Devices & Hardware', 'devices-hardware', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (75, 8, 'Everything is a File (/dev)', 'everything-is-a-file-dev', '
...
brw-rw---- 1 root disk 8, 0 Mar  7 /dev/sda  # ''b'' means Block device!</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (96, 75, 'Run <code>ls -l /dev/null</code> and check its permissions. Note the ''c'' indicating a Character device.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (75, 75, 'What does the ''b'' stand for at the beginning of the file permissions string for /dev/sda?', '["Binary", "Block device", "Basic file", "Background process"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (76, 8, 'CPU & Memory Analysis', 'cpu-memory-analysis', '
...
$ cat /proc/meminfo        # Deep kernel dump of memory hardware and swapping</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (97, 76, 'Run <code>free -h</code> and check your ''available'' memory vs ''free'' memory. Linux caches files in RAM, so ''available'' is the true metric.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (76, 76, 'Which command provides a quick, human-readable summary of your total and available RAM?', '["cat /proc/meminfo", "lscpu", "free -h", "htop"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (77, 8, 'General Hardware Discovery', 'general-hardware-discovery', '
...
$ hwinfo --short           # Quick summary of hardware nodes</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (98, 77, 'Run <code>sudo lshw -short</code> to see a list of device classes like ''processor'', ''memory'', ''bridge'', and ''network''.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (77, 77, 'Which flag is appended to lshw to output the hardware tree into a clean, easy-to-read table?', '["-table", "-format", "-short", "-list"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (78, 8, 'Storage & Block Devices', 'storage-block-devices', '
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (99, 78, 'Run <code>lsblk</code>. Identify your primary hard drive (usually sda or nvme0n1) and see how many partitions exist beneath it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (78, 78, 'Which command visualizes your hard drives and their partitions in a hierarchical tree layout?', '["lshw", "lsblk", "fdisk", "df"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (79, 8, 'Storage Space & I/O', 'storage-space-i-o', '
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (100, 79, 'Navigate to <code>/var/log</code> and run <code>sudo du -sh * | sort -h</code> to find the largest log files.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (79, 79, 'You want to find out how much space the current directory and its contents are consuming on the hard drive. Which command isolates this data?', '["df -h", "du -sh *", "iostat", "lsblk"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (80, 8, 'USB and PCI Buses', 'usb-and-pci-buses', '
...
$ sudo usb-devices         # Extremely detailed text dump of USB topology and power limits</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (101, 80, 'Run <code>lspci | grep -i network</code> to isolate the make and model of your WiFi or Ethernet card.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (80, 80, 'Which command lists hardware connected to the motherboard''s internal expansion slots (like Graphics Cards and Network Interfaces)?', '["lsusb", "lspci", "lsblk", "lscpu"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (81, 8, 'Graphics and Audio', 'graphics-and-audio', '
...
$ aplay -l                 # List all physical audio playback devices (speakers/headphones)</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (102, 81, 'Run <code>aplay -l</code> to see how your computer lists its audio outputs. If you use HDMI, your GPU might be listed as a sound card!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (81, 81, 'If you have an NVIDIA graphics card installed with proprietary drivers, which command provides a live monitor of its temperature and VRAM usage?', '["nvidia-top", "nvidia-smi", "gpu-monitor", "lspci -vga"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (82, 8, 'Network Interfaces', 'network-interfaces', '
...
$ ping google.com          # Send ICMP packets to test if the hardware is successfully routing to the internet</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (103, 82, 'Run <code>ip a</code>. Find the interface named <code>lo</code> (loopback) and note its IPv4 address (it should be 127.0.0.1).', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (82, 82, 'Which command is the modern, standard method to view all available network interfaces alongside their assigned IP addresses?', '["netstat", "ip a", "ifconfig", "lspci"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (83, 8, 'Power and Batteries', 'power-and-batteries', '
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (104, 83, 'If you are on a laptop, run <code>acpi -V</code> to check your battery percentage and thermal zone temperatures.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (83, 83, 'Which command generates a text summary of your laptop''s battery charge and thermal cooling states?', '["power-stat", "acpi -V", "lshw -battery", "top"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (84, 8, 'Kernel Messages and BIOS', 'kernel-messages-and-bios', '
...
$ dmesg -w                 # Follow mode: Leave it open to watch the kernel react live as you plug/unplug hardware</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (105, 84, 'Open a terminal and run <code>dmesg -w</code>. Physically plug a USB flash drive into your computer. Watch the text instantly scroll as the kernel detects and mounts the hardware!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (84, 84, 'Which command continuously monitors the kernel''s internal ring buffer, displaying live messages when new hardware is plugged in?', '["dmesg -w", "htop", "syslog", "lshw -live"]', 0);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (9, 'Filesystem & Storage', 'filesystem-storage', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (85, 9, 'Filesystem Hierarchy Standard (FHS)', 'filesystem-hierarchy-standard-fhs', '
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (106, 85, 'Navigate to <code>/var/log</code> and list the file sizes using <code>ls -lh</code>. This is where your system constantly writes events.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (85, 85, 'Which directory holds system-wide configuration files for installed services?', '["/bin", "/home", "/var", "/etc"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (86, 9, 'Disk Partitioning (fdisk & parted)', 'disk-partitioning-fdisk-parted', '
...
$ sudo gdisk /dev/sdb        # GPT-focused partition editor</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (107, 86, 'Run <code>sudo fdisk -l</code> to list all partition tables. Identify the partition scheme (MBR or GPT) of your primary drive.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (86, 86, 'Which partition table format is the modern standard, supports 128+ partitions, and removes the 2TB drive limit?', '["MBR", "FAT32", "GPT", "ext4"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (87, 9, 'Filesystem Formats (ext4, xfs, btrfs)', 'filesystem-formats-ext4-xfs-btrfs', '
...
$ df -Th                        # View the type of every currently mounted filesystem</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (108, 87, 'Run <code>df -Th</code> and look at the ''Type'' column. Identify what filesystem your root partition (/) uses.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (87, 87, 'Which command is used to create (format) an ext4 filesystem on a newly created partition?', '["fdisk", "mkfs.ext4", "mount", "parted"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (88, 9, 'Mounting & Unmounting Storage', 'mounting-unmounting-storage', '
...
$ sudo umount /mnt/data             # Step 3: Safely detach the drive when finished</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (109, 88, 'Run <code>mount | grep -v ''^none''</code> to see a list of every storage device and virtual filesystem currently mounted.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (88, 88, 'After running ''sudo mount /dev/sdb1 /mnt/data'', where will the drive''s contents appear?', '["Under /dev/sdb1", "Directly at /", "Under /mnt/data", "At /media/"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (89, 9, 'Persistent Mounts (/etc/fstab)', 'persistent-mounts-etc-fstab', '
...
$ sudo mount -a                     # Test fstab by mounting everything declared in it (catch typos!)</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (110, 89, 'Run <code>cat /etc/fstab</code>. Compare the mount points listed there against what <code>mount</code> shows as currently active.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (89, 89, 'After editing /etc/fstab, which command lets you test the configuration and mount all declared entries without rebooting?', '["mount --all", "sudo fstab -test", "sudo mount -a", "sudo reload fstab"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (90, 9, 'Inodes & the VFS', 'inodes-the-vfs', '
...
$ stat <filename>              # Show full inode metadata: size, timestamps, inode number, etc.</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (111, 90, 'Run <code>stat /etc/hostname</code> to see the complete inode metadata for a system file, including access and modification times.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (90, 90, 'What critical piece of information does a file''s inode store?', '["The filename", "The file''s metadata and pointer to its data blocks", "The partition table", "The mount point"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (91, 9, 'Hard Links & Soft Links', 'hard-links-soft-links', '
...
$ ls -la /webroot                   # Shows: /webroot -> /var/www/html</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (112, 91, 'Create a file called <code>test.txt</code>, then create a symlink to it using <code>ln -s test.txt link.txt</code>. Delete <code>test.txt</code> and see what happens to <code>link.txt</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (91, 91, 'What is the key difference between a hard link and a symbolic (soft) link?', '["Hard links can only link directories", "Soft links point to the inode directly, hard links point to the name", "Hard links point to the same inode; soft links point to the filename", "They are functionally identical"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (92, 9, 'Disk Space Management', 'disk-space-management', '
...
$ du -sh /* 2>/dev/null   # A quick health check: see the top-level folder sizes from root</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (113, 92, 'Run <code>df -h</code> on your system. Is any partition above 80% full? That''s the warning threshold for a production server.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (92, 92, 'You need to find which specific subdirectory within /var is consuming the most disk space. Which command is best suited?', '["df -h /var", "lsblk /var", "du -sh /var/*", "fdisk /var"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (93, 9, 'Swap Space', 'swap-space', '
...
$ free -h                           # Verify the swap total increased!</pre>
            ...
            ', 8);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (114, 93, 'Run <code>free -h</code> and inspect the ''Swap'' row. Is any swap currently in use? Heavy swap usage signals the system is under memory pressure.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (93, 93, 'What is the purpose of Linux Swap space?', '["A backup of the RAM content", "A disk area used as overflow memory when RAM is full", "Temporary file storage for /tmp", "A specialized filesystem for logs"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (94, 9, 'LVM (Logical Volume Manager)', 'lvm-logical-volume-manager', '
...
$ sudo lvextend -L +20G /dev/my_vg/data  # Grow the volume by 20GB ONLINE (no downtime!)</pre>
            ...
            ', 9);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (115, 94, 'Run <code>sudo lvs</code> or <code>sudo pvs</code> to check if LVM is already configured on your system.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (94, 94, 'What is LVM''s key advantage over traditional disk partitions?', '["LVM partitions run faster", "LVM allows logical volumes to be resized dynamically without downtime", "LVM prevents data loss", "LVM is required for ext4"]', 1);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (10, 'Boot & Kernel', 'boot-kernel', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (95, 10, 'BIOS, UEFI & POST', 'bios-uefi-post', '
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (116, 95, 'Run <code>sudo dmidecode -t bios</code> to read the raw firmware version of your motherboard without rebooting.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (95, 95, 'What is the key advantage of UEFI over legacy BIOS?', '["UEFI runs faster games", "UEFI supports GPT disks beyond 2TB and includes Secure Boot", "UEFI only works with Linux", "UEFI has no graphics interface"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (96, 10, 'GRUB Bootloader', 'grub-bootloader', '
...
$ sudo grub2-mkconfig -o /boot/grub2/grub.cfg   # Red Hat equivalent</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (117, 96, 'View your <code>/boot/grub/grub.cfg</code> file. Find the ''menuentry'' blocks that represent each bootable kernel installed.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (96, 96, 'After editing /etc/default/grub, which command must you run to apply changes by regenerating the GRUB configuration file?', '["systemctl restart grub", "reboot", "sudo update-grub", "grub --apply"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (97, 10, 'The Linux Kernel', 'the-linux-kernel', '
...
$ ls /boot                         # See all installed kernel files</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (118, 97, 'Run <code>uname -a</code> to print your full system information including kernel version, architecture, and compile date.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (97, 97, 'What is the purpose of the ''initramfs'' during the early stages of Linux boot?', '["It''s a GUI boot screen", "It''s a temporary mini-filesystem giving the kernel tools to load the real root filesystem", "It initializes hardware drivers permanently", "It is the main swap partition"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (98, 10, 'Kernel Modules', 'kernel-modules', '
...
$ sudo modprobe -r bluetooth      # Safely UNLOAD the bluetooth driver</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (119, 98, 'Run <code>lsmod | wc -l</code> to count how many kernel modules are currently loaded on your system.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (98, 98, 'Which command safely loads a kernel module AND automatically resolves and loads any dependencies it requires?', '["lsmod", "insmod", "modprobe", "loadmod"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (99, 10, 'systemd and Targets', 'systemd-and-targets', '
...
$ sudo systemctl isolate graphical.target        # Switch to graphical mode RIGHT NOW</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (120, 99, 'Run <code>systemctl get-default</code> to see if your machine boots into a <code>graphical.target</code> (desktop) or <code>multi-user.target</code> (server).', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (99, 99, 'Which command shows the current default systemd target that the system boots into?', '["systemctl status", "systemctl get-default", "runlevel", "init show"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (100, 10, 'Managing Services (systemctl)', 'managing-services-systemctl', '
...
$ sudo systemctl is-enabled nginx # Check if it is boot-enabled</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (121, 100, 'Run <code>systemctl status sshd</code> to see the full status and last 10 log lines of your SSH service.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (100, 100, 'Which systemctl command reloads a service''s configuration WITHOUT stopping active connections?', '["restart", "refresh", "reload", "update"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (101, 10, 'journalctl (System Logs)', 'journalctl-system-logs', '
...
$ journalctl -p err                # Show ONLY error-level (and worse) messages</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (122, 101, 'Run <code>journalctl -u sshd --since today</code> to view all SSH server log entries generated today.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (101, 101, 'Which journalctl flag filters the output to ONLY show logs from a specific service unit?', '["-s", "-f", "-u", "-p"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (102, 10, 'Boot Troubleshooting', 'boot-troubleshooting', '
                <h1>Recovery Mode</h1>
...
$ sudo fsck /dev/sda1              # Check and repair a corrupted filesystem</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (123, 102, 'Research how to boot into ''single-user mode'' on your specific Linux distribution''s GRUB menu.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (102, 102, 'After making changes in Recovery Mode, which command ensures the root filesystem is writable before you can edit files?', '["chmod 777 /", "sudo mount -o remount,rw /", "fsck /", "systemctl start disk"]', 1);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (11, 'System Administration', 'system-administration', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (103, 11, 'Automated Tasks (Cron)', 'automated-tasks-cron', '
...
# DOM=Day of Month, DOW=Day of Week (0=Sunday)</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (124, 103, 'Use the online tool <a href=''https://crontab.guru'' target=''_blank''>crontab.guru</a> to decipher the cron expression <code>0 18 * * 1-5</code>. When does it run?', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (103, 103, 'In the cron expression `*/15 * * * *`, what does `*/15` in the minute field mean?', '["Run at minute 15 exactly", "Run exactly 15 times per day", "Run every 15 minutes", "Run for 15 minutes"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (104, 11, 'Systemd Timers', 'systemd-timers', '
...
$ sudo systemctl enable --now mytask.timer   # Activate and start a timer immediately</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (125, 104, 'Run <code>systemctl list-timers</code> to see all active systemd timers, including important system maintenance tasks like <code>apt-daily.timer</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (104, 104, 'What key advantage do systemd timers have over cron jobs?', '["They run faster", "They can run missed jobs on next boot and log to the journal", "They support more complex time schedules", "All of the above"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (105, 11, 'System Logging', 'system-logging', '
...
$ grep "Failed password" /var/log/auth.log  # Hunt for SSH brute-force evidence</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (126, 105, 'Run <code>grep ''sudo'' /var/log/auth.log | tail -20</code> to see the last 20 sudo commands executed on the system.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (105, 105, 'Which log file on a Debian/Ubuntu system records all authentication events, including failed SSH logins?', '["/var/log/syslog", "/var/log/kern.log", "/var/log/auth.log", "/var/log/messages"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (106, 11, 'Log Rotation (logrotate)', 'log-rotation-logrotate', '
...
$ sudo logrotate -d /etc/logrotate.conf   # Dry-run: see what WOULD happen without doing it</pre>
    ...
    missingok
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (127, 106, 'Look inside <code>/etc/logrotate.d/</code> to see how a specific service''s log rotation is configured.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (106, 106, 'What is the primary purpose of the logrotate utility?', '["Monitor logs for errors", "Parse logs and send alerts", "Automatically compress and remove old log files to save disk space", "Forward logs to a remote server"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (107, 11, 'Resource Monitoring', 'resource-monitoring', '
...
$ sar -u 5 10           # Sample CPU utilization 10 times, every 5 seconds (from sysstat)</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (128, 107, 'Run <code>htop</code> and press <code>F6</code> to sort by Memory usage. Identify which processes are consuming the most RAM.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (107, 107, 'On a server with 4 CPU cores, approximately what load average value indicates the CPUs are saturated (100% utilized)?', '["1.0", "4.0", "0.25", "100"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (108, 11, 'Backup Strategies (tar & rsync)', 'backup-strategies-tar-rsync', '
...
# -a=Archive mode (preserves permissions/times), v=Verbose, z=compress in transit</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (129, 108, 'Create a compressed tar backup of your <code>/etc</code> directory using <code>sudo tar -czvf /tmp/etc-backup.tar.gz /etc</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (108, 108, 'Why is rsync preferred over a simple tar+scp for repeated backups of large directories?', '["rsync is more secure", "rsync only transfers changed files, making it much faster for incremental updates", "rsync creates a single archive file", "rsync is built into the kernel"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (109, 11, 'Disk Integrity (fsck)', 'disk-integrity-fsck', '
...
$ sudo fsck -y /dev/sdb1            # Step 3: Interactive repair (auto-yes all fixes)</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (130, 109, 'View your system''s automatically scheduled filesystem check history by running <code>sudo tune2fs -l /dev/sda1 | grep ''Last checked''</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (109, 109, 'What critical precaution must be taken BEFORE running fsck on a partition?', '["Reboot the system first", "The partition must be unmounted", "Backup the partition table with fdisk", "Enable journaling first"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (110, 11, 'User Auditing', 'user-auditing', '
...
$ sudo auditctl -w /etc/passwd -p wa  # Watch for writes to /etc/passwd</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (131, 110, 'Run <code>last | head -20</code> to see the last 20 login sessions, including remote IP addresses.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (110, 110, 'Which command shows not only who is logged in, but also what command they are currently executing?', '["who", "last", "w", "users"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (12, 'Networking', 'networking', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (111, 12, 'IP Addressing & Interfaces', 'ip-addressing-interfaces', '
...
$ ifconfig                 # Legacy tool (install via net-tools if missing)</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (132, 111, 'Run <code>ip addr</code> and identify the IP of your primary network card. Is it a private (192.168.x.x / 10.x.x.x) or public IP?', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (111, 111, 'Which modern command replaces the deprecated ''ifconfig'' for viewing IP addresses on Linux?', '["netstat", "ip addr", "route", "arp"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (112, 12, 'Connectivity Testing (ping & traceroute)', 'connectivity-testing-ping-traceroute', '
...
$ mtr google.com               # Combines ping + traceroute into a live, dynamic view</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (133, 112, 'Run <code>mtr google.com</code>. Watch the packet loss column. Any non-zero value at a hop indicates potential congestion or filtering.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (112, 112, 'Which command shows the entire path packets travel from your computer to a remote host, one router ''hop'' at a time?', '["ping", "ip route", "traceroute", "ss"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (113, 12, 'DNS & Name Resolution', 'dns-name-resolution', '
...
$ cat /etc/resolv.conf         # See which DNS server your system queries</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (134, 113, 'Run <code>dig google.com</code> and find the ''ANSWER SECTION''. Note the IP address returned and compare it across different networks.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (113, 113, 'Which configuration file specifies the DNS server IP address that the Linux system uses for name resolution?', '["/etc/hosts", "/etc/dns.conf", "/etc/resolv.conf", "/etc/network/dns"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (114, 12, 'Ports & Active Connections (ss)', 'ports-active-connections-ss', '
...
$ netstat -tulpn               # Legacy equivalent using the net-tools package</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (135, 114, 'Run <code>sudo ss -tulpn</code> and look at the ''Process'' column. Identify what process is listening on port 22 (SSH).', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (114, 114, 'Which command shows all open TCP/UDP ports along with the process name that owns each listening socket?', '["ping -l", "dig --ports", "ss -tulpn", "ip addr show"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (115, 12, 'SSH (Secure Shell)', 'ssh-secure-shell', '
...
$ ssh-copy-id user@server          # Push your public key to the server</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (136, 115, 'Run <code>ssh-keygen -t ed25519</code> to create an SSH key pair. Inspect the public key content with <code>cat ~/.ssh/id_ed25519.pub</code>.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (115, 115, 'Which command securely copies a file between systems using the SSH protocol?', '["rcp", "ftp", "scp", "cp -r"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (116, 12, 'Firewall Basics (UFW)', 'firewall-basics-ufw', '
...
$ sudo ufw enable                # Activate the firewall</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (137, 116, 'Run <code>sudo ufw status</code>. Is your firewall active? (WARNING: Before enabling, ALWAYS run <code>sudo ufw allow ssh</code> first if on a remote server!)', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (116, 116, 'What is the ''golden rule'' when setting up a new UFW firewall policy?', '["Allow all incoming traffic first, then deny specific threats", "Deny all incoming traffic by default, then selectively allow required services", "Disable the firewall during setup", "Allow all ports under 1024"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (117, 12, 'Network File Transfer (rsync, wget, curl)', 'network-file-transfer-rsync-wget-curl', '
...
$ rsync -avz /local/dir/ user@server:/remote/  # Sync a directory (only changed files)</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (138, 117, 'Use <code>curl -I https://google.com</code> to view the HTTP response headers. Note the ''Content-Type'', ''Server'', and redirect status codes returned.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (117, 117, 'Which tool synchronizes directories over a network by only transferring files that have changed since the last sync?', '["wget", "ftp", "curl", "rsync"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (118, 12, 'Network Monitoring (tcpdump & netstat)', 'network-monitoring-tcpdump-netstat', '
...
$ netstat -rn                       # Show the kernel routing table (legacy)</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (139, 118, 'Run <code>sudo tcpdump -i lo port 22 -c 5</code> and then SSH to localhost in another terminal. Watch the packets appear!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (118, 118, 'Which tcpdump flag saves captured packets to a file for later analysis in a tool like Wireshark?', '["-f", "-r", "-w", "-s"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (13, 'Security', 'security', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (119, 13, 'User Security & Password Policies', 'user-security-password-policies', '
...
$ sudo passwd -u john         # UNLOCK John''s account</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (140, 119, 'Run <code>chage -l $USER</code> to inspect your own account''s password aging policy.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (119, 119, 'Which command is used to view or change password expiration and account aging policies?', '["passwd", "usermod", "chage", "chmod"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (120, 13, 'File Permissions & ACLs', 'file-permissions-acls', '
...
$ setfacl -m u:bob:r-- file.txt      # Grant bob read-only access via ACL</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (141, 120, 'Check your SSH private key with <code>ls -la ~/.ssh/id_rsa</code>. It MUST show <code>-rw-------</code> (600). SSH will refuse to use it if it''s world-readable!', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (120, 120, 'Which permission value (in octal notation) gives only the file owner read and write access, and denies all access to group and others?', '["755", "644", "600", "777"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (121, 13, 'SSH Hardening', 'ssh-hardening', '
...
$ sudo systemctl restart sshd  # Apply changes</pre>
            ...
            ', 2);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (142, 121, 'Review your SSH server configuration: <code>sudo cat /etc/ssh/sshd_config | grep -v ''^#'' | grep .</code>. Is PermitRootLogin set to no?', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (121, 121, 'What is the most important sshd_config change to make after setting up key-based authentication?', '["Change the default SSH port", "Set PasswordAuthentication no", "Enable X11 forwarding", "Reduce the connection timeout"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (122, 13, 'Fail2Ban (Intrusion Prevention)', 'fail2ban-intrusion-prevention', '
...
$ sudo fail2ban-client set sshd unbanip 1.2.3.4  # Manually unban an IP</pre>
            ...
            ', 3);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (143, 122, 'Install and start Fail2ban, then run <code>sudo fail2ban-client status sshd</code> to see how many bots are already attacking your SSH port.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (122, 122, 'What does Fail2ban do when it detects an IP address with too many failed login attempts?', '["It restarts the SSH service", "It adds a firewall rule to temporarily block that IP", "It alerts the system administrator by email", "It disables the user account"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (123, 13, 'Firewall Rules (iptables)', 'firewall-rules-iptables', '
...
$ sudo iptables-save > /etc/iptables/rules.v4   # Persist rules across reboots</pre>
            ...
            ', 4);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (144, 123, 'Run <code>sudo iptables -L -nv</code> to see the low-level firewall rules currently in effect. You may see rules added by UFW or Docker.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (123, 123, 'In iptables, rules are evaluated in order. If you add a DROP all rule BEFORE your ACCEPT ssh rule, what happens?', '["SSH still works because ACCEPT rules always win", "SSH is blocked because DROP is matched first", "iptables reorders rules automatically", "Only UFW rules matter"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (124, 13, 'SELinux & AppArmor (MAC)', 'selinux-apparmor-mac', '
...
$ sudo aa-enforce /etc/apparmor.d/usr.sbin.nginx  # Put nginx in enforcing mode</pre>
            ...
            ', 5);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (145, 124, 'Run <code>sestatus</code> (Red Hat) or <code>sudo aa-status</code> (Ubuntu/Debian) to see if MAC is enabled on your system.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (124, 124, 'If a web server running as www-data is compromised, how does SELinux prevent access to /home/user/ files?', '["It monitors the process for suspicious activity", "Its policy context restricts the web server process from accessing files outside its defined scope", "It changes the file owner automatically", "It blocks all network connections"]', 1);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (125, 13, 'Audit Logging (auditd)', 'audit-logging-auditd', '
...
$ sudo aureport -l                     # Generate a login/authentication summary report</pre>
            ...
            ', 6);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (146, 125, 'Run <code>sudo aureport --summary</code> to get a high-level summary of all security events recorded by the kernel audit system.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (125, 125, 'Which tool writes security audit events DIRECTLY to kernel ring buffer, making them impossible for a compromised root process to tamper with?', '["syslog", "journald", "auditd", "rsyslog"]', 2);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (126, 13, 'Vulnerability Scanning & Hardening', 'vulnerability-scanning-hardening', '
...
$ sudo rkhunter --check         # Alternative rootkit hunter scan</pre>
            ...
            ', 7);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (147, 126, 'Install and run <code>sudo lynis audit system</code>. Review the ''Hardening index'' score and the ''Suggestions'' section at the end of the report.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (126, 126, 'Which tool runs a comprehensive security hardening audit of a Linux system and provides a ''Hardening Index'' score?', '["nmap", "ncal", "lynis", "fail2ban"]', 2);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (14, 'Virtualization', 'virtualization', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (127, 14, 'Virtual Machines (KVM/QEMU)', 'virtual-machines-kvm-qemu', '
...
$ virt-manager                 # The popular graphical GUI to click-and-create VMs</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (148, 127, 'Research <code>virt-manager</code>. It is the open-source equivalent to VMware Workstation or VirtualBox, but it runs natively via KVM with near bare-metal performance.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (127, 127, 'Which component of the Linux Virtualization stack is actually built directly into the core Linux kernel?', '["QEMU", "virt-manager", "libvirt", "KVM"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (128, 14, 'Containers (Docker / Podman)', 'containers-docker-podman', '
...
$ docker exec -it [id] /bin/bash # "SSH" directly into the running container</pre>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (149, 128, 'If you have Docker installed, run <code>docker run -it ubuntu /bin/bash</code> to instantly pop a shell inside a pristine Ubuntu sandbox. Type <code>exit</code> to destroy it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (128, 128, 'Why do Docker containers start up in milliseconds, whereas Virtual Machines take minutes to boot?', '["Containers do not require hard drives.", "Containers share the running host kernel and skip the entire OS boot sequence.", "Containers execute in RAM only.", "Docker uses a highly compressed image format."]', 1);
INSERT INTO modules (id, name, slug, description, is_locked) VALUES (15, 'Monitoring & Troubleshooting', 'monitoring-troubleshooting', '', 0);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (129, 15, 'System Diagnostics', 'system-diagnostics', '
...
$ vmstat 1         # Watch virtual memory swapping (if swap is high, you need more RAM)</pre>
            ...
            ', 0);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (150, 129, 'Run <code>df -Th</code>. Identify which filesystem holds your <code>/</code> (root) directory and see what percentage is used.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (129, 129, 'When running the `free -h` command, which column indicates the true amount of RAM you have left to start new applications?', '["total", "used", "free", "available"]', 3);
INSERT INTO lessons (id, module_id, title, slug, content, order_index) VALUES (130, 15, 'Network Diagnostics', 'network-diagnostics', '
...
$ dig +short github.com # Directly test DNS resolution</pre></li>
            ...
            ', 1);
INSERT INTO exercises (id, lesson_id, description, order_index) VALUES (151, 130, 'Follow the 5-step test above on your own machine. Find your default gateway using <code>ip route</code> and ping it.', 0);
INSERT INTO quiz_questions (id, lesson_id, question, options, correct_option_index) VALUES (130, 130, 'If you can successfully ping an external IP address (like 8.8.8.8) but cannot reach a domain name (like google.com), what is the most likely culprit?', '["Your ethernet cable is unplugged", "Your router is powered off", "Your DNS server is misconfigured or unreachable", "Your ISP blocked your IP address"]', 2);
